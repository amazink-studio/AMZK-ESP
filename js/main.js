...
document.getElementById('pie').innerHTML = `
	<footer>
			...
			<div id="contacto_form">
				...
				<form
					...
					<div>
						...
						<div>
							<label for="organizacion">A qué organización, institución o empresa perteneces</label>
							<input
								type="text"
								name="organizacion"
								id="organizacion"
								required />
							<div class="empty-feedback invalid-feedback">
								* Por favor escribe el nombre de la organización, institución o empresa a la que perteneces
							</div>
						</div>
					</div>
					...
					<div>
						...
						<div class="empty-feedback">
							* Por favor escribe tu correo electrónico de contacto
						</div>
					...
					<div>
						<label 
							...
							<input 
								...
								id="habeas"
								required> 
								Autorizo a Amazink Estudio a contactarme.
							<div class="empty-feedback invalid-feedback">
								* Debes marcar esta casilla para poder enviar el mensaje
							</div>
						</label>
					</div>
		...
		<div id="legal">
			<p>Todos los derechos reservados. Amazink, 2023.</p>
		</div>
